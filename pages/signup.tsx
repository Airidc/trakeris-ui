...
import { changeCurrentPage, selectAppConfig } from "../lib/store/slices/appConfigSlice";
...
export default function signUpPage() {
    ...
    dispatch(changeCurrentPage({ currentPage: "Register" }))
    const { apiUrl, currentPage } = useAppSelector(selectAppConfig);

    const inputRefs = useRef<signUpRefs>({});
    ...
    return (
        <div className="auth-page__container">
            <Head>
                <title>[TRK] Trakeris - Sign up!</title>
            ...
            <form className="form" onSubmit={submitLogin}>
                ...
                <div className="form__control__row">
                    ...
                    <input ref={el => inputRefs.current['confirmPassword'] = el} type="password" name="confirmPassword" id="confirmPassword" className="form__control__input" />
                </div>
                <div className="form__control__row">
                    <button type="submit">Sign in</button>
                    <p>Forgor your password? <Link href="/reset"><a className="form__link">Click here</a></Link></p>
                    <p>Have an account already? <Link href="/signin"><a className="form__link">Log in</a></Link></p>
